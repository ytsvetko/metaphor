...
parser.add_argument("--an_threshold", default="{'L': 1.0, 'M': 1.0}", 
    help="Posteriors threshold for AdjN relations")
parser.add_argument("--svo_threshold", default="{'L': 1.0, 'M': 1.0}", 
    help="Posteriors threshold for SVO relations")
